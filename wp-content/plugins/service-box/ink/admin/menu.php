	...
	text-decoration:none;
		...
		margin-right:10px;	
			...
			<div class="pro-button-div">
				<a class="btn btn-danger btn-lg " href="https://wpshopmart.com/plugins/service-showcase-pro-plugin-wordpress/" target="_blank">Check Pro Version</a><a class="btn btn-success btn-lg " href="https://wpshopmart.com/plugins/service-showcase-pro-plugin-wordpress/" target="_blank">Team Pro Demo</a>
			</div>				
		<?php
	}
