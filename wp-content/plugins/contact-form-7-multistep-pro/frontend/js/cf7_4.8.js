		  		...
		  		if ($(this).attr("name") != "" && typeof $(this).attr("name") != 'undefined') { 
			  		...
			  		if( name_tab.indexOf(name) < 0 ) {
						...
						if( type != "text" ){
				  		...
				  		step_comfirm_html +='<div class="cf7-step-confirm-item '+hide_it+'"><div class="cf7-step-confirm-name">'+ value+': </div><div class="cf7-step-confirm-value">'+ data +'</div></div>';
			  		} 
		  		}		
		  	})
			...
			var ajaxSuccess = function( data, status, xhr, $form ) {
				...
				switch ( data.status ) {
						...
						$.each( data.invalidFields, function( i, n ) {
						 ...
						 if( !error_tab ) {
			                ...
			                */
							...
							if(tab_current==3 && ($(".Signupfinalsubmission").length>0)){
								
								$(".multistep").val("2");console.log("tab_current"+tab_current);
							$(".Signupfinalsubmission").trigger( "click" );}
			            }else{
					...
					case 'mail_sent':
						...
						if($(".Signupfinalsubmission").length==0){
