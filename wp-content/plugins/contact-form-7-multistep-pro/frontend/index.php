                        ...
                        <div class="container-multistep-header <?php  if( $type == 6 ) {echo "hidden";}?>">
                            <ul class="cf7-display-steps-container cf7-display-steps-container-<?php echo $type ?>">
                                	...
                                	<li class="<?php if( $i== 1){echo "active"; $key_active = $key; } ?> cf7-steps-<?php echo $i ?>" data-i="<?php echo $i ?>" data-tab=".cf7-tab-<?php echo $i ?>">
                                		<?php _e(apply_filters("cf7_multistep_remove_key",$key),CT_7_MULTISTEP_TEXT_DOMAIN); ?>
                                	</li>
                                    <?php
                                    $i++;
                                     endforeach; ?>
                            ...
                            <div class="cf7-tab <?php if( $i!= 1){ echo "hidden";} ?> cf7-tab-<?php echo $i ?>" >
                                ...
                                <div class="multistep-nav">
                                    <div class="multistep-nav-left">
                                        <?php  if( $i!=1): ?>
                                         <a href="#" class="multistep-cf7-first"><?php _e($settings["multistep_cf7_steps_first"],CT_7_MULTISTEP_TEXT_DOMAIN);  ?></a><a href="#" class="multistep-cf7-prev"><?php _e($settings["multistep_cf7_steps_prev"],CT_7_MULTISTEP_TEXT_DOMAIN);  ?></a>
                                        <?php endif; ?>
                                    </div>
                                    <div class="multistep-nav-right">
                                        <?php if( $count_tab != $i ): ?>

                                        <a href="#" class="multistep-cf7-next"><?php _e($settings["multistep_cf7_steps_next"],CT_7_MULTISTEP_TEXT_DOMAIN);  ?> <span class="ajax-loader hidden"></span></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
