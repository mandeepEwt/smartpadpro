...
<div class="wrap">
	...
	<h2><?php _e( 'Hire Us - Get unlimited expert WordPress Support and Development', 'wp-testimonial-with-widget' ); ?></h2><br />

	<div class="support-data">
	<h3 style="margin-bottom:5px;"><?php _e( 'Highlight of Hiring:', 'wp-testimonial-with-widget' ); ?></h3>
		<ul>
